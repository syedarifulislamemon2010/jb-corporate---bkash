...
class ListBkashTransactionConfirmations extends ListRecords
{
    ...
    public function getBatches(): Collection
    {
        ...
        // Exclude failed batches from confirmation queue
    ...
    public function confirmSelectedBatches(): void
    {
        ...
        foreach ($batches as $batch) {
            // Guard: Failed transaction files can NEVER be authorized/confirmed. Automatically revert to checker!
            if ($batch->hasFailedTransactions()) {
                ...
                \Filament\Notifications\Notification::make()
                    ...
                    ->body("File '{$batch->file_name}' contains failed transactions and cannot be confirmed. It has been automatically returned to Checker - Verify Files.")
                    ->danger()
                    ->persistent()
                    ->send();
                continue;
