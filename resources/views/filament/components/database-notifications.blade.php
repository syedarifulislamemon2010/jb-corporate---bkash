                    ...
                    <div class="jb-notif-actions-toolbar">
                        <div class="jb-notif-actions-left">
                            @if ($unreadNotificationsCount && $this->markAllNotificationsAsReadAction?->isVisible())
                                ...
                                >
                                    <svg class="w-3.5 h-3.5" style="width: 14px; height: 14px; min-width: 14px; max-width: 14px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="jb-notif-icon-col">
                                <div @class([
                                    ...
                                    @if ($category === 'checker')
                                        ...
                                        <svg class="w-4 h-4" style="width: 16px; height: 16px; min-width: 16px; max-width: 16px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @else
            ...
            <div class="jb-notif-empty-state">
                <div class="jb-notif-empty-icon">
                    <svg class="w-10 h-10" style="width: 28px; height: 28px; min-width: 28px; max-width: 28px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
